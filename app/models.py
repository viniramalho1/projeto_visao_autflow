...
class Exame(db.Model):
    ...
    input9 = db.Column(db.Float, nullable=True)
    ...
    input4 = db.Column(db.Float, nullable=True)
    ...
    input6 = db.Column(db.Float, nullable=True)
    input7 = db.Column(db.Float, nullable=True)
    input8 = db.Column(db.Float, nullable=True)
